...
print("построение деревьев решений в Plots 3 4 5")
...
print("видим, как переобучение влияет на показатели для тестового набора данных")
from sklearn.tree import export_graphviz

print("Анализ деревьев")
...
ram_prices = pd.read_csv("C:/MyStudy/32/МСХОАД/pythonProject1/ram_price.csv")
